...
class Administrator extends CI_Controller {
	...
	function kategori_produk(){
		...
		$data['record'] = $this->model_app->view_ordering('tb_kategori_produk','id_kategori_produk','DESC');
	...
	function tambah_kategori_produk(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->insert('tb_kategori_produk',$data);
	...
	function edit_kategori_produk(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->update('tb_kategori_produk', $data, $where);
			redirect('administrator/kategori_produk');
		}else{
			$edit = $this->model_app->edit('tb_kategori_produk',array('id_kategori_produk'=>$id))->row_array();
	...
	function delete_kategori_produk(){
		...
		$this->model_app->delete('tb_kategori_produk',$id);
		redirect('administrator/kategori_produk');
	}
	...
	function produk(){
		...
		$data['record'] = $this->model_app->view_ordering('tb_produk','id_produk','DESC');
	...
	function tambah_produk(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->insert('tb_produk',$data);
	...
	function edit_produk(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->update('tb_produk', $data, $where);
			redirect('administrator/produk');
		}else{
			$data['record'] = $this->model_app->view_ordering('tb_kategori_produk','id_kategori_produk','DESC');
			$data['rows'] = $this->model_app->edit('tb_produk',array('id_produk'=>$id))->row_array();
	...
	function delete_produk(){
		...
		$this->model_app->delete('tb_produk',$id);
		redirect('administrator/produk');
	}
	...
	function pembelian(){
		...
		$data['record'] = $this->model_app->view_join_one('tb_pembelian','tb_supplier','id_supplier','id_pembelian','DESC');
		$this->template->load('administrator/template','administrator/mod_pembelian/view_pembelian',$data);
	}

	function detail_pembelian(){
		cek_session_akses('pembelian',$this->session->id_session);
		$data['rows'] = $this->model_app->view_join_rows('tb_pembelian','tb_supplier','id_supplier',array('id_pembelian'=>$this->uri->segment(3)),'id_pembelian','DESC')->row_array();
		$data['record'] = $this->model_app->view_join_where('tb_pembelian_detail','tb_produk','id_produk',array('id_pembelian'=>$this->uri->segment(3)),'id_pembelian_detail','DESC');
	...
	function tambah_pembelian(){
		...
		if (isset($_POST['submit1'])){
			if ($this->session->idp == ''){
				...
				$this->model_app->insert('tb_pembelian',$data);
				...
				$this->model_app->update('tb_pembelian', $data, $where);
			}
	        ...
	        if ($this->input->post('idpd')==''){
				...
				$this->model_app->insert('tb_pembelian_detail',$data);
			}else{
				...
				$this->model_app->update('tb_pembelian_detail', $data, $where);
			}
			redirect('administrator/tambah_pembelian');
		}else{
			$data['rows'] = $this->model_app->view_join_rows('tb_pembelian','tb_supplier','id_supplier',array('id_pembelian'=>$this->session->idp),'id_pembelian','DESC')->row_array();
			$data['record'] = $this->model_app->view_join_where('tb_pembelian_detail','tb_produk','id_produk',array('id_pembelian'=>$this->session->idp),'id_pembelian_detail','DESC');
			$data['barang'] = $this->model_app->view_ordering('tb_produk','id_produk','ASC');
			$data['supplier'] = $this->model_app->view_ordering('tb_supplier','id_supplier','ASC');
			if ($this->uri->segment(3)!=''){
				$data['row'] = $this->model_app->view_where('tb_pembelian_detail',array('id_pembelian_detail'=>$this->uri->segment(3)))->row_array();
			}
	...
	function edit_pembelian(){
		...
		if (isset($_POST['submit1'])){
			...
			if ($this->uri->segment(4)!=''){
				$data['row'] = $this->model_app->view_where('tb_pembelian_detail',array('id_pembelian_detail'=>$this->uri->segment(4)))->row_array();
			}
	...
	function delete_pembelian(){
		...
		$this->model_app->delete('tb_pembelian',$id);
		$this->model_app->delete('tb_pembelian_detail',$id);
	...
	function tracking(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->update('tb_penjualan', $data, $where);
	...
	function supplier(){
		...
		$data['record'] = $this->model_app->view_ordering('tb_supplier','id_supplier','DESC');
	...
	function tambah_supplier(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->insert('tb_supplier',$data);
	...
	function edit_supplier(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->update('tb_supplier', $data, $where);
			redirect('administrator/supplier');
		}else{
            $proses = $this->model_app->edit('tb_supplier', array('id_supplier' => $id))->row_array();
	...
	function delete_supplier(){
		...
		$this->model_app->delete('tb_supplier',$id);
		redirect('administrator/supplier');
	}
