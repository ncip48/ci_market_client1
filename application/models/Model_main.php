...
class Model_main extends CI_model{
    ...
    function keterangan(){
        return $this->db->query("SELECT * FROM tb_keterangan ORDER BY id_keterangan DESC LIMIT 1");
    }
    ...
    function keterangan_update(){
        ...
        $this->db->update('tb_keterangan',$datadb);
    }

    function settingbonus(){
        return $this->db->query("SELECT * FROM tb_setting where aktif='Y' ORDER BY id_setting DESC LIMIT 1");
    }
    ...
    function settingbonus_update(){
            ...
            $this->db->update('tb_setting',$datadb);
    }
