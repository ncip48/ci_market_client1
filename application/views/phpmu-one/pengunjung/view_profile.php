...
<table id='example1' class='table table-hover table-condensed'>
                ...
                <tbody>
                  <?php 
                    $no = 1;
                    $record = $this->model_app->view_where_ordering('tb_penjualan',array('id_pembeli'=>$this->session->id_konsumen),'id_penjualan','DESC');
