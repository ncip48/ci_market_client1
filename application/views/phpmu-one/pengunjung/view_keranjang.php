...
?>
      <table class="table table-striped table-condensed">
        ...
        <?php 
          ...
          $total = $this->db->query("SELECT sum((a.harga_jual*a.jumlah)-(b.diskon*a.jumlah)) as total, sum(b.berat*a.jumlah) as total_berat FROM `tb_penjualan_temp` a JOIN tb_produk b ON a.id_produk=b.id_produk where a.session='".$this->session->idp."'")->row_array();
      ...
      $ket = $this->db->query("SELECT * FROM tb_keterangan")->row_array();
