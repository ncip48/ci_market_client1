            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <?php $jmlb = $this->db->query("SELECT * FROM tb_kategori_produk")->num_rows(); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <?php $jmlc = $this->db->query("SELECT * FROM tb_produk")->num_rows(); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <?php $jmld = $this->db->query("SELECT * FROM tb_penjualan")->num_rows(); ?>
